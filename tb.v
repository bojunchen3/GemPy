...
module tb;
  ...
  initial begin
    ...
    weight_vals[32] = -2139972;
    weight_vals[33] = 241447;
    weight_vals[34] = 4054683;
    weight_vals[35] = -2941342;
    weight_vals[36] = 1005200;
    weight_vals[37] = 1491038;

    weight_vals[40] = -2299722;
    weight_vals[41] = 1579352;
    weight_vals[42] = -3478139;
    weight_vals[43] = 2970766;
    weight_vals[44] = -1283374;
    weight_vals[45] = -89444;

    weight_vals[48] = 1456157;
    weight_vals[49] = 1205270;
    weight_vals[50] = 1434798;
    weight_vals[51] = 454853;
    weight_vals[52] = -1946847;
    weight_vals[53] = -751262;

    weight_vals[56] = -1360790;
    weight_vals[57] = 19479;
    weight_vals[58] = -505014;
    weight_vals[59] = 565089;
    weight_vals[60] = -312332;
    weight_vals[61] = 102181;

    weight_vals[64] = 32700;
    weight_vals[65] = -16767;
    weight_vals[66] = 115236;
    ...
    vec_vals[17][  DATA_WIDTH-1:            0] = 120; // interface layer 2
    vec_vals[17][2*DATA_WIDTH-1:   DATA_WIDTH] = 600;
    vec_vals[17][3*DATA_WIDTH-1: 2*DATA_WIDTH] = 240;
    vec_vals[18][  DATA_WIDTH-1:            0] = 800;
    vec_vals[18][2*DATA_WIDTH-1:   DATA_WIDTH] = 200;
    vec_vals[18][3*DATA_WIDTH-1: 2*DATA_WIDTH] = 200;
    vec_vals[19][  DATA_WIDTH-1:            0] = 450;
    vec_vals[19][2*DATA_WIDTH-1:   DATA_WIDTH] = 180;
    vec_vals[19][3*DATA_WIDTH-1: 2*DATA_WIDTH] = 250;
    vec_vals[20][  DATA_WIDTH-1:            0] = 300;
    vec_vals[20][2*DATA_WIDTH-1:   DATA_WIDTH] = 300;
    vec_vals[20][3*DATA_WIDTH-1: 2*DATA_WIDTH] = 300;
    vec_vals[21][  DATA_WIDTH-1:            0] = 700;
    vec_vals[21][2*DATA_WIDTH-1:   DATA_WIDTH] = 550;
    vec_vals[21][3*DATA_WIDTH-1: 2*DATA_WIDTH] = 200;
    vec_vals[22][  DATA_WIDTH-1:            0] = 600;
    vec_vals[22][2*DATA_WIDTH-1:   DATA_WIDTH] = 430;
    vec_vals[22][3*DATA_WIDTH-1: 2*DATA_WIDTH] = 230;
    vec_vals[23][  DATA_WIDTH-1:            0] = 950;
    vec_vals[23][2*DATA_WIDTH-1:   DATA_WIDTH] = 200;
    vec_vals[23][3*DATA_WIDTH-1: 2*DATA_WIDTH] = 300;

    vec_vals[26][  DATA_WIDTH-1:            0] = 150; // interface layer 3
    vec_vals[26][2*DATA_WIDTH-1:   DATA_WIDTH] = 460;
    vec_vals[26][3*DATA_WIDTH-1: 2*DATA_WIDTH] = 460;
    vec_vals[27][  DATA_WIDTH-1:            0] = 880;
    vec_vals[27][2*DATA_WIDTH-1:   DATA_WIDTH] = 120;
    vec_vals[27][3*DATA_WIDTH-1: 2*DATA_WIDTH] = 400;
    vec_vals[28][  DATA_WIDTH-1:            0] = 500;
    vec_vals[28][2*DATA_WIDTH-1:   DATA_WIDTH] = 700;
    vec_vals[28][3*DATA_WIDTH-1: 2*DATA_WIDTH] = 430;
    vec_vals[29][  DATA_WIDTH-1:            0] = 350;
    vec_vals[29][2*DATA_WIDTH-1:   DATA_WIDTH] = 400;
    vec_vals[29][3*DATA_WIDTH-1: 2*DATA_WIDTH] = 400;
    vec_vals[30][  DATA_WIDTH-1:            0] = 700;
    vec_vals[30][2*DATA_WIDTH-1:   DATA_WIDTH] = 500;
    vec_vals[30][3*DATA_WIDTH-1: 2*DATA_WIDTH] = 500;
    vec_vals[31][  DATA_WIDTH-1:            0] =  50;
    vec_vals[31][2*DATA_WIDTH-1:   DATA_WIDTH] = 600;
    vec_vals[31][3*DATA_WIDTH-1: 2*DATA_WIDTH] = 500;
    vec_vals[32][  DATA_WIDTH-1:            0] =1000;
    vec_vals[32][2*DATA_WIDTH-1:   DATA_WIDTH] = 900;
    vec_vals[32][3*DATA_WIDTH-1: 2*DATA_WIDTH] = 390;

    vec_vals[35][  DATA_WIDTH-1:            0] = 125; // interface layer 4
    vec_vals[35][2*DATA_WIDTH-1:   DATA_WIDTH] = 500;
    vec_vals[35][3*DATA_WIDTH-1: 2*DATA_WIDTH] = 620;
    vec_vals[36][  DATA_WIDTH-1:            0] = 250;
    vec_vals[36][2*DATA_WIDTH-1:   DATA_WIDTH] = 660;
    vec_vals[36][3*DATA_WIDTH-1: 2*DATA_WIDTH] = 620;
    vec_vals[37][  DATA_WIDTH-1:            0] = 375;
    vec_vals[37][2*DATA_WIDTH-1:   DATA_WIDTH] = 200;
    vec_vals[37][3*DATA_WIDTH-1: 2*DATA_WIDTH] = 620;
    vec_vals[38][  DATA_WIDTH-1:            0] = 500;
    vec_vals[38][2*DATA_WIDTH-1:   DATA_WIDTH] = 100;
    vec_vals[38][3*DATA_WIDTH-1: 2*DATA_WIDTH] = 620;
    vec_vals[39][  DATA_WIDTH-1:            0] = 625;
    vec_vals[39][2*DATA_WIDTH-1:   DATA_WIDTH] = 800;
    vec_vals[39][3*DATA_WIDTH-1: 2*DATA_WIDTH] = 620;
    vec_vals[40][  DATA_WIDTH-1:            0] = 750;
    vec_vals[40][2*DATA_WIDTH-1:   DATA_WIDTH] = 620;
    vec_vals[40][3*DATA_WIDTH-1: 2*DATA_WIDTH] = 620;
    vec_vals[41][  DATA_WIDTH-1:            0] = 875;
    vec_vals[41][2*DATA_WIDTH-1:   DATA_WIDTH] = 200;
    vec_vals[41][3*DATA_WIDTH-1: 2*DATA_WIDTH] = 620;

    vec_vals[44][  DATA_WIDTH-1:            0] = 250; // interface layer 5
    vec_vals[44][2*DATA_WIDTH-1:   DATA_WIDTH] = 500;
    vec_vals[44][3*DATA_WIDTH-1: 2*DATA_WIDTH] = 920;
    vec_vals[45][  DATA_WIDTH-1:            0] = 100;
    vec_vals[45][2*DATA_WIDTH-1:   DATA_WIDTH] = 660;
    vec_vals[45][3*DATA_WIDTH-1: 2*DATA_WIDTH] = 850;
    vec_vals[46][  DATA_WIDTH-1:            0] = 330;
    vec_vals[46][2*DATA_WIDTH-1:   DATA_WIDTH] = 200;
    vec_vals[46][3*DATA_WIDTH-1: 2*DATA_WIDTH] = 860;
    vec_vals[47][  DATA_WIDTH-1:            0] = 450;
    vec_vals[47][2*DATA_WIDTH-1:   DATA_WIDTH] = 100;
    vec_vals[47][3*DATA_WIDTH-1: 2*DATA_WIDTH] = 820;
    vec_vals[48][  DATA_WIDTH-1:            0] = 660;
    vec_vals[48][2*DATA_WIDTH-1:   DATA_WIDTH] = 800;
    vec_vals[48][3*DATA_WIDTH-1: 2*DATA_WIDTH] = 910;
    vec_vals[49][  DATA_WIDTH-1:            0] = 780;
    vec_vals[49][2*DATA_WIDTH-1:   DATA_WIDTH] = 620;
    vec_vals[49][3*DATA_WIDTH-1: 2*DATA_WIDTH] = 810;
    vec_vals[50][  DATA_WIDTH-1:            0] = 940;
    vec_vals[50][2*DATA_WIDTH-1:   DATA_WIDTH] = 200;
    vec_vals[50][3*DATA_WIDTH-1: 2*DATA_WIDTH] = 760;
